                  ...
                  <template slot-scope="props">
                    <el-form label-position="left" inline class="demo-table-expand">
                      ...
                      <el-form-item label="食品价格">
                        <span>￥{{ props.row.food_price }}</span>
                      </el-form-item>
            ...
            <el-dialog
                ...
                <el-form :model="selectTable">
                    ...
                    <el-form-item label="食品分类" label-width="100px">
	                    <el-select v-model="selectTable.left_name_id" :placeholder="selectTable.left_name" @change="handleSelect">
						    <el-option
					...
					<el-form-item label="价格" label-width="100px">
						<el-input-number v-model="selectTable.food_price" :min="0" :max="10000"></el-input-number>
					</el-form-item>
    ...
    export default {
        ...
        methods: {
            initData(){
                ...
                console.log(a)
                this.$ajax.post('shopFoodlist',{shop_num:a}).then((res)=>{
            ...
            updateFood(){
                ...
                let a=this.selectTable;
                console.log(a);
                this.$ajax.post('updateFood',{food_id:a.food_id,
                food_name:a.food_name,
                left_name_id:a.left_name_id,
                food_img:this.imageUrl,
                food_price:a.food_price}).then(((res)=>{
                    console.log(res.data.data);
                    if (res.data.data === 1) {
                        this.$message({
                            type: 'success',
